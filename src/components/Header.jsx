            ...
            <div className="offcanvas-body ">
                  ...
                  <ul className="navbar-nav  navbar-right justify-content-start ul1   flex-grow-1 pe-3">
                    ...
                    <li className="nav-item me-3">
                      <a className="nav-link na-cont" aria-current="page" href="#">MEN</a>
                    </li><li className="nav-item me-3">
                      <a className="nav-link na-cont" aria-current="page" href="#">WOMEN</a>
                    </li>
                    <li className="nav-item me-3">
                      <a className="nav-link na-cont" aria-current="page" href="#">KIDS</a>
                    </li>
